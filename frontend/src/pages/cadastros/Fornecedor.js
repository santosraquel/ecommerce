...
const Fornecedor = () => {
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <div className="my-2">
                    <Button label="Novo Fornecedor" icon="pi pi-plus" className="p-button-success mr-2" onClick={openNew} />
                </div>
            </React.Fragment>
        )
    }
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable ref={dt} value={fornecedores}
                        ...
                        currentPageReportTemplate="Showing {first} to {last} of {totalRecords} fornecedores"
