...
const Cidade = () => {
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <div className="my-2">
                    <Button label="Nova Cidade" icon="pi pi-plus" className="mr-2" style={{backgroundColor:'#ff008d'}} onClick={openNew} />
                </div>
            </React.Fragment>
        )
    }
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h4 className="m-0" style={{color: '#ff008d'}}>Cidades Cadastradas</h4>
    ...
    placeholder="Selecione um Estado" required autoFocus className={classNames({ 'p-invalid': submitted && !cidade.estado })}filter/>
                                {submitted && !cidade.estado && <small className="p-invalid">Campo obrigatório.</small>}
